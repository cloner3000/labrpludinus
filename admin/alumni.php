...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="proses-delete-alumni.php?id=<?php echo $pecah['id'] ?>" class="btn-danger btn">Hapus</a>
				<a href="form-update-alumni.php?id=<?php echo $pecah['id'] ?>" class="btn-warning btn" id="update" data-target="#update">Update</a>
  ...
  <div class="modal-dialog" style="width: 80%" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			<form action="proses-create-alumni.php" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="tahun_lulus" id="exampleInputPassword1" placeholder="Tahun Lulus">
			  </div>
			  <div class="form-group">
