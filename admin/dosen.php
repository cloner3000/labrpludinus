...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="proses-delete-dosen.php?id=<?php echo $pecah['id'] ?>" class="btn-danger btn">Hapus</a>
				<a href="form-update-dosen.php?id=<?php echo $pecah['id'] ?>" class="btn-warning btn">Update</a>
  ...
  <div class="modal-dialog" style="width: 80%" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			<form action="proses-create-dosen.php" method="post">
