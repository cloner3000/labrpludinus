<?php 
  ...
  session_start();
	...
	include "koneksi.php";
	$id=$_GET['id'];
	$ambil = "SELECT * FROM ebook WHERE id=$id";
...
font-size: 16px;"><a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
        <h5>Form Update Download Ebook</h5>
        <form action="proses-update-ebook.php" method="post">
          <input type="hidden" name="id" value="<?php echo $id ?>">
           ...
           <div class="form-group">
              ...
              <input type="text" class="form-control" name="link" value="<?php echo $link ?>" aria-describedby="emailHelp" placeholder="Link" >
           </div>
           <div class="form-group">
              <label for="exampleFormControlTextarea1">Jenis</label>
              <input type="text" class="form-control" name="jenis" value="<?php echo $jenis ?>" aria-describedby="emailHelp" placeholder="Jenis" >
           </div>
