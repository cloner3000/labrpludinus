<?php 
  ...
  session_start();
	...
	include "koneksi.php";
	$id=$_GET['id'];
	$ambil = "SELECT * FROM publikasi WHERE id=$id";
...
font-size: 16px;"><a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				<h5>Form Update Publikasi</h5>
				<form action="proses-update-publikasi.php" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="tlink" id="exampleInputPassword1" value="<?php echo $link ?>">
            </div>
