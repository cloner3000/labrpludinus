...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="proses-delete-berita.php?id=<?php echo $pecah['id'] ?>" class="btn-danger btn">Hapus</a>
				<a href="form-update-berita.php?id=<?php echo $pecah['id'] ?>" class="btn-warning btn" id="update" data-target="#update">Update</a>
  ...
  <div class="modal-dialog" style="width: 80%" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
			<form action="proses-create-berita.php" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="kategori" id="exampleInputPassword1" placeholder="Kategori">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">Gambar</label>
			    <input type="file" class="form-control-file" name="gambar" id="exampleInputPassword1">
			  </div>
			  <div class="form-group">
