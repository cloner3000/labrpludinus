<?php 
  ...
  session_start();
	...
	include "koneksi.php";
	$id=$_GET['id'];
	$ambil = "SELECT * FROM berita WHERE id=$id";
...
font-size: 16px;"><a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				...
				<form action="proses-update-berita.php" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama" value="<?php echo $nama ?>" aria-describedby="emailHelp" placeholder="Nama" >
            </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="kategori" value="<?php echo $kategori ?>" placeholder="Peserta">
					  </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Gambar</label>
              <input type="file" class="form-control-file" name="gambar" id="exampleInputPassword1" value="<?php echo $gambar ?>">
            </div>
					 <div class="form-group">
              <label for="exampleFormControlTextarea1">Isi</label>
              <textarea class="form-control" name="isi" id="exampleFormControlTextarea1" rows="3" value="<?php echo $isi ?>"></textarea>
           </div>
           <div class="form-group">
