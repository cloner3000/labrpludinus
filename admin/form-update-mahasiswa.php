<?php 
  ...
  session_start();
	...
	include "koneksi.php";
	$id=$_GET['id'];
	$ambil = "SELECT * FROM mahasiswa WHERE id=$id";
...
font-size: 16px;"><a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				<h5>Form Update Mahasiswa</h5>
				<form action="proses-update-mahasiswa.php" method="post">
					<input type="hidden" name="id" value="<?php echo $id ?>">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" name="nim" value="<?php echo $nim ?>" placeholder="NIM">
					  </div>
					  <div class="form-group">
