...
font-size: 16px;"><a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
				<h5>Form Update Kegiatan</h5>
				<form action="proses-update-kegiatan.php" method="post">
					<input type="hidden" name="id" value="<?php echo $id ?>">
					  <div class="form-group">
					    <label for="exampleInputEmail1">Nama Kegiatan</label>
					    <input type="text" class="form-control" name="nama_kegiatan" value="<?php echo $nama_kegiatan ?>" aria-describedby="emailHelp" placeholder="Nama Kegiatan" >
					  </div>
					  <div class="form-group">
					    <label for="exampleInputPassword1">Tanggal</label>
					    <input type="date" class="form-control" class="text-center" name="tanggal" value="<?php echo $tanggal ?>" placeholder="Tanggal">
					  </div>
					  <div class="form-group">
					    <label for="exampleInputPassword1">Peserta</label>
					    <input type="text" class="form-control" name="peserta" value="<?php echo $peserta ?>" placeholder="Peserta">
					  </div>
					 <div class="form-group">
           ...
           <div class="form-group">
              ...
              <input type="text" class="form-control" name="waktu" id="exampleInputPassword1" value="<?php echo $waktu ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Tempat</label>
              <input type="text" class="form-control" name="tempat" id="exampleInputPassword1" value="<?php echo $tempat ?>">
            </div>
